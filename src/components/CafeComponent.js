...
function Cafe() {
    return (
        <div>
            ...
            <p className="mr-md-3">That is why we here at ED's Athenaeum we are proud to offer our own inhouse coffee service, the Evergreens Café. Inspired by the <a target="_blank" href="https://www.emilydickinsonmuseum.org/the-museum/our-site/the-evergreens/">adult home</a> of Austin Dickinson built in 1856, our coffee shop seeks to invoke the aesthetic of the famed house's Italianate domestic architecture while serving you great coffee. Our coffee blends are crafted by our own staff and served at cost to save you every penny. Cause after all, our focus here isn't on the coffee or the money, but solely on our love of literature. The coffee is just meant as an added bonus so we strongly recommend that you try some. Afterall, you cannot read on an empty stomach.</p>
